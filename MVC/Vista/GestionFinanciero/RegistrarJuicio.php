...
<section class="content-header">
    <h1>
        Registro Juicio Coactiva por Actualización
    </h1>
    <hr class="style8">
</section>
<section class="content container-fluid">
    <div Registro >
        ...
        <div class="row hidden" new>
            <form savePersonalizado action="_financiero" role="JUICIOCOACTIVANO">
                        ...
                        <div class="box-body" DatosDeuda>
                            <div class="row ">
                                <div class="col-md-6 inline">
                                    <div class="form-group form-group-sm">
                                        <label class="control-label">Fecha Registro Convenio:</label>
                                        <div class="input-group date">
                                            <div class="input-group-addon">
                                                <i class="fa fa-calendar"></i>
                                            </div>
                                            <input type="text" class="form-control " name="fechareg" data-tipo="fecha"  dt-tipo="day" required>
                                            <input type="text" class="hidden" name="fechafindeuda" data-tipo="fecha"  dt-tipo="day" required>
                                        </div>
                                    </div>
                                </div>                            
                                <div class="col-md-6">
...
<script src="recurso/Vista/GestionFinanciero/RegistrarJuicio.js" type="text/javascript"></script>
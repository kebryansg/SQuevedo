...
<section class="content container-fluid">
    <div Registro >
        <div class="row">
            ...
            <div Reimprimir class="col-md-6 col-md-offset-3 hidden">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
...
<script src="recurso/Vista/GestionFinanciero/ReimpresionRegistroJuicio.js" type="text/javascript"></script>
...
//        include SITE_ROOT . '/MVC/Vista/Recursos/stylePrint.php';
//        include SITE_ROOT . '/MVC/Vista/Recursos/scriptPrint.php';
            ...
            <div class="row" style="border: blue solid 2px;">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="" style="text-align:center;">
                        ...
                        <h4 class="bold" for="">INACTIVACIÓN DE GUIA</h4>
                    ...
                    <p class="lead text-justify" style="padding-top: 20px;font-size:18px;">
                        ...
                        Recibí de <span contribuyente>PLUA CRUZ NARDA LILIANA</span>  con CCI: <span class="bold" identificacion></span> CIU: 54383, el valor de <span class="bold" valor></span> dólares americanos </span> por concepto de 

                        <span class="bold">ABONO AL CONVENIO DE FACILIDAD DE PAGO SUSCRITO POR LA DEUDA PENDIENTE CON ESTA EMPRESA</span><span>, CORRESPONDIENTE A LA GUIA : </span><span class="bold">CCAAPP </span><span ccaapp class="bold"></span>
                ...
                <div class="col-xs-12 text-center" style="padding-top: 30px;">
                    ...
                    <h4 class="bold">DIRECTOR FINANCIERO</h4>
    ...
    <script type="text/javascript">
        ...
        $("span[fecha]").html(moment(fecha).format("D [de] MMMM [del] YYYY"));

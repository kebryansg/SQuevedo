...
<section class="content-header">
    <h1>
        Reportes por Tipo de Documento Administrativo
    </h1>
    <hr class="style8">
</section>
<section class="content container-fluid flex-row">
    <div class="box box-info" style="width: 40%;">
        <div class="box-header with-border">
            <h3 class="box-title"> <i class="fa fa-file-excel"></i> Reporte Administrativo</h3>
        </div>
...
<script src="recurso/Vista/Reportes/ReporteDocumentoAdministrativo.js" type="text/javascript"></script>
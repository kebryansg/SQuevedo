...
<html>
    ...
    <script type="text/javascript">
        ...
        entero = Math.trunc(datos.valor);
        decimal = ((datos.valor % 1) * 100).toFixed(0);
        $("span[valor]").html(datos.valor + " (" + CifrasEnLetras.convertirNumeroEnLetras(entero).toUpperCase() + " DOLARES CON " + decimal + "/100) ");

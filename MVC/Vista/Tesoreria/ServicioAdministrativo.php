...
<section class="content container-fluid">
    <div Listado>
        ...
        <table
            ...
            data-ajax="tbServicioAdministrativo"
    ...
    <div Registro class="hidden">
        <form save action="_tesoreria" role="servicioadministrativo">
...
<script src="recurso/Vista/Tesoreria/ServicioAdministrativo.js" type="text/javascript"></script>